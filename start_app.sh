...
echo ""
echo "================================================="
echo "   PDF to Speech Converter - Linux Launcher"
echo "================================================="
echo ""
...
if [ ! -f "venv/bin/flask" ]; then
    ...
    echo "Ubuntu/Debian: sudo apt install ffmpeg libsndfile1"
    echo "Fedora/CentOS: sudo dnf install ffmpeg libsndfile"
